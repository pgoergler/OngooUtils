...
namespace OngooHiddenNamespace
{
    ...
    {
        if(class_exists('\Ongoo\Onyx\Configuration') )
        {
            return \Ongoo\Onyx\Configuration::getInstance()->get('application');
        }
        return null;
    }
}
...
namespace
{
    ...
    {
        $dependencyInjection = \OngooHiddenNamespace\getContainer();
